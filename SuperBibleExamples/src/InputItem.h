...
/**
	InputItem
	Purpose: Class to hold a single input message such as a keypress or mousemove
	Author: Jeff Adams
*/
...
// #definitions
#define GE_INPUT_NONE				0		// this should never really happen.  There shouldn't be an input item if there is no input.
#define GE_INPUT_KEY				1
#define GE_INPUT_MOUSEBUTTON		2
#define GE_INPUT_MOUSEPOSITION		3
#define GE_INPUT_MOUSESCROLL		4


// Key Definitions.  Based on GLFW but modified to suit needs.
...
/* Input Actions */
#define GE_ACTION_NONE				-1
#define GE_ACTION_RELEASE			0
#define GE_ACTION_PRESS				1
#define GE_ACTION_REPEAT			2
